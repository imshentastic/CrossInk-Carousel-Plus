...
#
# Emits ../builtinFonts/cjk_16_regular.h -- a 2-bit, UNCOMPRESSED (memory-
# mapped, zero heap at draw time) LXGW WenKai face covering:
...
OUT="../builtinFonts/cjk_16_regular.h"
...
python3 fontconvert.py cjk_16_regular 16 "$CJK_FONT" \
