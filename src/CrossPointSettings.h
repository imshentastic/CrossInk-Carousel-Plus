...
class CrossPointSettings {
 ...
 public:
  ...
  //
  // CrumBLE 4.1: defaulted off again after an always-on attempt produced
  // unexpected heap pressure / mismatch-prompt UX on devices whose
  // existing prebake artifacts were generated by a build with different
  // font hashes. Users who want it on toggle Settings -> Library ->
  // Optimize Chapter Indexing.
